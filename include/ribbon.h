...
typedef struct {
    ...
    char mainselect[4]; // 0 - select, 1 - mouseHover, 2 - selected, 3 - premove close dropdown
    char subselect[4]; // 0 - select, 1 - mouseHover, 2 - selected, 3 - free
    char output[3]; // 0 - toggle, 1 - mainselect, 2 - subselect
    char mouseDown; // keeps track of previous frame mouse information
...
void ribbonDarkTheme() { // dark theme preset
    ribbonRender.colors[0] = 60.0;
    ribbonRender.colors[1] = 60.0;
    ribbonRender.colors[2] = 60.0;
    ribbonRender.colors[3] = 80.0;
    ribbonRender.colors[4] = 80.0;
    ribbonRender.colors[5] = 80.0;
    ribbonRender.colors[6] = 60.0;
    ribbonRender.colors[7] = 60.0;
    ribbonRender.colors[8] = 60.0;
    ribbonRender.colors[9] = 150.0;
...
void ribbonDraw() {
    ...
    turtleQuad(ribbonRender.bounds[0], ribbonRender.bounds[3] - 10, ribbonRender.bounds[2], ribbonRender.bounds[3] - 10, ribbonRender.bounds[2], ribbonRender.bounds[3], ribbonRender.bounds[0], ribbonRender.bounds[3], ribbonRender.colors[0], ribbonRender.colors[1], ribbonRender.colors[2], 0.0); // render ribbon
